...
function escreverLetraIncorreta(teclaAdic, erros){
	tabuleiro.font = "bold 40px Inter";
	tabuleiro.lineCap = "round";
	tabuleiro.fillStyle = "red";
	tabuleiro.lineWidth = 6;
	tabuleiro.fillText(teclaAdic, 400 +(40*(10 - erros)),350,40)
}
	...
	function winner (){
		...
		tabuleiro.lineWidth=8;
		tabuleiro.fillStyle='green'; 
  		tabuleiro.fillText('Parabéns!',820, 80);
